...
6. Fit the model based on your suggestion in Question 4 to predict variation in the log-transformed FCI (do not include sporting league in these models). Use the test for nested models (the $\Delta$F test) to examine whether the any higher-order terms are necessary. Provide the output of the test, and comment on whether the results suggest whether the higher-order terms tested are warranted. 
