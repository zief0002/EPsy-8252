...
```{r out.width='3in', fig.cap="Six-Year Graduation Rate as a Function of Median SAT Score"}
# Scatterplot
...
```{r tidy=FALSE, out.width='3in', fig.cap="Standardized Residuals versus the Fited Values for a Model Regressing Six-Year Graduation Rates on Median SAT Scores"}
# Fit linear model
...
```{r tidy=FALSE, out.width='3in', fig.cap="Standardized Residuals versus the Fited Values for a Model Regressing Six-Year Graduation Rate on Linear and Quadratic Effects of Median SAT Scores"}
# Obtain residuals
out_2 = augment(lm.2)
...
```{r out.width='3in', fig.cap="Density Plot of the Standardized Residuals for a Model Regressing Six-Year Graduation Rate on Linear and Quadratic Effects of Median SAT Scores", echo=FALSE}
...
```{r out.width='3in', fig.cap="Scatterplot of Six-Year Graduation Rate versus Median SAT Score with Prediction Curve"}
# Scatterplot
ggplot(data = mn, aes(x = sat, y = grad)) +
...
```{r out.width='3in', fig.cap="Six-Year Graduation Rate as a Function of Median SAT Score for Private (Red, Solid Line) and Public (Blue, Dashed Line) Institutions"}
