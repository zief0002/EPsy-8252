...
new_session: yes
before_chapter_script: ["setup-script.R"]
...
## Assignments, Data Sets, Codebooks, and Scripts {-}

The assignments, datasets, and R script files for the course can be found on our accompanying github site:

- https://github.com/zief0002/epsy-8252

Directions for downloading these materials are found on that site.

The data codebooks can be found in the appendix of this document: [Data Codebooks](#data-codebook)
