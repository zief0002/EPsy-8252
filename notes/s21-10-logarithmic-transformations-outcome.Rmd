...
```{r fig_03, fig.cap='Scatterplot between running time and log-transformed budget. Movies with extreme running times or budgets are identified. The loess smoother (blue, dashed line) is also displayed.', out.width='4in'}
# Scatterplot
...
```{r out.width='3in', fig.cap='The fitted curves from the model with linear and quadratic effects of running time for both action movies (red, solid line) and non-action movies (black, dashed line) are displayed.'}
# Plot
ggplot(data = movies, aes(x = length, y = budget)) +
  geom_point(alpha = 0) +
...
In reporting your candidate models, consider the story you want to present. It is not necessary to present every model you fitted in the analysis in a publication.^[It is, however, good ethical practice to make the script file you used available to other researchers. This would include ALL the models fitted and analyses performed, even if they didn't make the final paper.] Here, the following models constitute the primary narrative that I would write about in a publication:
...
stargazer(
  lm.1, lm.poly, lm.3, lm.4, lm.6,
  type = "html",
  title = "Five candidate models predicting variation in movie budgets. The action movie predictor was dummy-coded using a non-action movies as the reference group.",
  column.labels = c("Model A", "Model B", "Model C", "Model D", "Model E"),
  colnames = FALSE,
  model.numbers = FALSE,
  dep.var.caption = " ",
  dep.var.labels = "",
  covariate.labels = c("Running time (Linear)", "Running time (Quadratic)", "Action movie", "Running time (Linear) x Action movie"),
  keep.stat = c("rsq", "ser"),
  notes.align = "l",
  star.cutoffs = NA
  )
...
<table class="table">
<caption>Five candidate models predicting variation in movie budgets. The action movie predictor was dummy-coded using a non-action movies as the reference group. In all models, the outcome was log-transformed using the natural logarithm.
</caption>
<thead>
  <tr>
    ...
    <th style="text-align:center;">Model E</th>
  </tr>
</thead>
<tbody>
  <tr><td colspan="6" style="text-align:center;font-style: italic;">Coefficient-level estimates</td></tr>
  <tr>
    <td style="text-align:left">Running time (Linear)</td>
    <td style="text-align:center;">0.80<br />(0.25)</td>
    <td style="text-align:center;">0.14<br />(0.04)</td>
    <td style="text-align:center;"></td>
    <td style="text-align:center;">0.12<br />(0.04)</td>
    <td style="text-align:center;">0.12<br />(0.04)</td>
  </tr>

  <tr>
    <td style="text-align:left">Running time (Quadratic)</td>
    <td style="text-align:center;"></td>
    <td style="text-align:center;">-0.0004<br />(0.0002)</td>
    <td style="text-align:center;"></td>
    <td style="text-align:center;">-0.0004<br />(0.0002)</td>
    <td style="text-align:center;">-0.0004<br />(0.0002)</td>
  </tr>
  ...
  <tr>
    <td style="text-align:left">Action movie</td>
    <td style="text-align:center;"></td>
    <td style="text-align:center;"></td>
    <td style="text-align:center;">1.00<br />(0.28)</td>
    <td style="text-align:center;">0.81<br />(0.27)</td>
    <td style="text-align:center;">-0.60<br />(1.71)</td>
  </tr>

  <tr>
    <td style="text-align:left">Running time (Linear) x Action movie</td>
    <td style="text-align:center;"></td>
    <td style="text-align:center;"></td>
    <td style="text-align:center;"></td>
    <td style="text-align:center;"></td>
    <td style="text-align:center;">0.01<br />(0.02)</td>
  </tr>

  <tr>
    <td style="text-align:left">Constant</td>
    <td style="text-align:center;">-32.83<br />(26.15)</td>
    <td style="text-align:center;">-6.28<br />(2.37)</td>
    <td style="text-align:center;">2.80<br />(0.11)</td>
    <td style="text-align:center;">-5.56<br />(2.35)</td>
    <td style="text-align:center;">-5.26<br />(2.38)</td>
  </tr>
...
```{r echo=FALSE}
# Make NA values blank in the table
