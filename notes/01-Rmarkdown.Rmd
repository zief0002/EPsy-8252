...
- Download the [sample BibTeX file](https://github.com/zief0002/epsy-8252/raw/master/notes/s19-notes/s19-01-r-markdown/myBibliography.bib)
...
- [Unit 01: R Markdown](https://github.com/zief0002/epsy-8252/raw/master/notes/s19-notes/s19-01-r-markdown/01-r-markdown.pdf) [Class Notes]


```{r}
knitr::include_url("http://www.datadreaming.org/files/01-introduction-to-r.html#1")
```
...
Finally, here are some references for using reveal.js and remark.js to create sweet-looking **presentations**:
