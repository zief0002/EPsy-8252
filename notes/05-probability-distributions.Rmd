...
```{r out.width='50%', fig.cap="Plot of the Probability Density Function (PDF) for a $\\mathcal{N}(50,10)$ Distribution", fig.pos="H"}
# Create dataset
fig_01 = data.frame(
...
```{r out.width='50%', echo=FALSE, fig.cap="Plot of the Cumulative Probability Density for $X$ of 65", fig.pos="H"}
# Create dataset
fig_02 = data.frame(
  X = seq(from = 10, to = 90, by = 0.01)
  ) %>% 
...
```{r out.width='50%', echo=FALSE, fig.cap='Cumulative Density Representing the p-Value for a Two-Tailed Test Using an Observed z-Value of 2.5', fig.pos="H"}
# Create data
fig_03 = data.frame(
...
```{r out.width='50%', echo=FALSE, fig.cap="Plot of the Probability Density Function (PDF) for the Standard Normal Distribution (Dotted, Red Line) and Student's t(5) Distribution (Solid, Black Line)", fig.pos="H"}
# Create data
fig_04 = data.frame(
  X = seq(from = -4, to = 4, by = 0.01)
) %>% 
...
```{r out.width='80%', echo=FALSE, fig.width=8, fig.height=6, fig.cap='Plot of Several t-Distributions with Differing Degrees of Freedom', fig.pos="H"}
df_03 = data.frame(
  X = seq(from = -4, to = 4, by = 0.01)
) %>% 
  rowwise() %>%
...
To illustrate how probability distributions are used in practice, we will will use the *riverview.csv* (see the [data codebook](https://zief0002.github.io/epsy-8252/codebooks/riverview.html) for more information about these data) and fit a regression model that uses education level and seniority to predict variation in employee income.
...
```{r out.width='80%', echo=FALSE, fig.width=8, fig.height=5, fig.cap='Plot of Several F-Distributions with Differing Degrees of Freedom', fig.pos="H"}
fig_07 = data.frame(
...
```{r out.width='80%', echo=FALSE, fig.width=8, fig.height=4, fig.cap="Cumulative Density Representing the p-Value Using an Observed F-Statistic of 41.7", fig.pos="H"}
# Create data
fig_08 = data.frame(
...
```{r echo=FALSE, out.width='70%', fig.cap="Visual Depiction of the Distributional Assumptions of the Residuals Underlying Linear Regression", fig.pos="H"}
