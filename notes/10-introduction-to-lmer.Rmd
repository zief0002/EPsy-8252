...
```{r fig.width=8, fig.height=4, out.width='6in', fig.cap='Residual Plots for the Fixed-Effects Regression Model', fig.pos='H'}
...
```{r fig.height=10, fig.width=12, out.width='90%', fig.cap='Scatterplots of the Standardized Residuals versus the Fitted Values Stratified by School', fig.pos='H'}
