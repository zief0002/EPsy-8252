...
```{r echo=FALSE, fig.cap="Plot of the probability density function (PDF) for a $\\chi^2(1)$ distribution. The greyshaded area represents the *p*-value based on $\\chi^2=9.5015$."}
# Create dataset
fig = data.frame(
