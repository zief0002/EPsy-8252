...
```{r fig.width=8, fig.height=6, fig.width=8, out.width='4.5in', fig.cap='Predicted probability of graduating college as a function of ACT score for first and non-first generation students.', fig.pos='H'}
# Create data to plot
plotData = crossing(
  act = seq(from = 10, to = 36, by = 1),
  firstgen = c(0, 1)
